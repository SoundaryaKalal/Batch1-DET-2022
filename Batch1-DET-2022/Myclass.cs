...
//            try
//            {
//                MyClass m = new MyClass(4671, "Karthika", new DateTime(2005, 5, 10), "techtrng", 10);  //default constructor
//                                                                                                   // Console.WriteLine(m.Print());

//                MyClass m1 = new MyClass(2345, "Jeeva", new DateTime(2010, 1, 14), "PEMS", 450);
//                // Console.WriteLine(m1.Print());  //base class ref can point to derived object

//                MyClass e1 = new MyClass(1, "Jiyana", new DateTime(2020, 1, 5));
//                //Console.WriteLine(e1.Print());

//                Console.WriteLine("enter empid b.w 1001 - 25000");
//                int id = Convert.ToInt32(Console.ReadLine());
//                if (id < 1001 || id > 25000)
//                    throw new Exception("Entered empid is not in the range...");
